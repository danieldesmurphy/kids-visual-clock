...
function makeDefaultSchedule() {
  return [
    ...
    { id: crypto.randomUUID(), label: "Free Time", start: "15:00", end: "18:00", color: COLORS[1] },
...
function KidClock({ kid, selectedDay, now }: any) {
  ...
  return (
    ...
    >
      <h2 style={{ fontSize: 32, fontWeight: 900 }}>{kid.name}</h2>
      <p style={{ color: "#64748b" }}>{selectedDay} schedule</p>
